...
$SQL_DATABASE_NAME = $phase4.sqlDatabaseName
...
$testPdf = Join-Path $env:TEMP "ai-doc-intel-phase4-test.pdf"
$pdfContent = @'
%PDF-1.4
1 0 obj
...
Invoke-RestMethod -Method POST "$APP_URL/documents/$($uploaded.id)/analyze" | ConvertTo-Json -Depth 8 | Write-Host
